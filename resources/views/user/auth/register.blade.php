...
<nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm p-3 mb-5 bg-body rounded">
    <div class="container">
      ...
      <button type="button" class="btn btn-lg rounded-3" style="background-color: #F4656E; width:100px;height:40px; color: white;font-size:16px;">Daftar</button>
    </div>
    </div>
  </nav>
                  ...
                  <form method="POST" action="{{ route('user.register') }}"  >
                    ...
                    {{ __('Register') }}
                      ...
                      <div class="mt-3 d-flex justify-content-center">
                          ...
                          <span>sudah punya akun?</span><a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('user.login') }}">
                              {{ __('Masuk') }}
                          </a>
                      </div>
